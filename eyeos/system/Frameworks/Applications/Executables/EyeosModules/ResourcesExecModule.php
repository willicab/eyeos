...
/**
 * ExecModule for the resources system.
 * Provide methods to browse and manage resources in the extern folder.
 *
 * @package kernel-frameworks
 * @subpackage Application
 */

class ResourcesExecModule implements IEyeosExecutableModule {
    public function checkExecutePermission() {
            SecurityManager::getInstance()->checkExecute($this);
    }
    public function getIconCategories($params) {
        $size = utf8_basename($params[0]);
        $categories = array();
